...
const kkasu1 = { name : 'kkasu'};
const kkasu2 = { name : 'kkasu'};
const kkasu3 = kkasu1;
console.log(kkasu1 == kkasu2); // wrong reference value
console.log(kkasu1 === kkasu2); // wrong reference value
console.log(kkasu1 === kkasu3);
